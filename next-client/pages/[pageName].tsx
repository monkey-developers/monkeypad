...
export default function Page() {
    ...
    const renderThemeChanger = () =>{
        ...
        if (currentTheme === 'dark'){
            return(
            <button className='rounded-full cursor-pointer flex p-4 w-[3.5rem] bg-slate-800' onClick={()=>setTheme('light')}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokewidth="1.5" stroke="currentColor" className="text-teal-500">
            ...
            return(
            <button className='rounded-full cursor-pointer flex p-4 w-[3.5rem] bg-teal-50' onClick={()=>setTheme('dark')}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokewidth="1.5" stroke="currentColor" className="text-teal-500">
